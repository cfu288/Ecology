...
### Climate
  ...
  * Temperatures that exceed thermal optima can be detrmimental
  * Coral bleaching
  * Thermal pollution
...
### Adaptations to environment:
  ...
  * **
* (HW) Identify a species, convince class why it is important. How humans are having an effect on species.
  ...
  * **Microhabitats** - locations within a habitat that differ in enviornmenal conditions from the rest of the habitats
  ...
  * **Migration, storage, and dormancy are strategies to survive extreme environmental variation**:
    ...
    * **Storage** - When resources are limited and migation is not possible, storage of resources can be an adaptive strategy. Fat or food supplies for animals, nutrients and energy in roots for plants
